...
const stats = [
  ...
  { label: 'Staff Members', value: '—', color: '#10b981', icon: '👨‍🏫' },
  { label: 'Revenue (Month)', value: '—', color: '#f59e0b', icon: '💰' },
  { label: 'Pending Fees', value: '—', color: '#ef4444', icon: '⚠️' },
];

const quickActions = [
  { label: 'Add Student', icon: '➕', color: '#6366f1' },
  { label: 'Record Payment', icon: '💳', color: '#10b981' },
  { label: 'Mark Attendance', icon: '✅', color: '#f59e0b' },
  { label: 'Send Notice', icon: '📢', color: '#3b82f6' },
  { label: 'View Reports', icon: '📊', color: '#8b5cf6' },
  { label: 'Manage Staff', icon: '👥', color: '#ec4899' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container}>
        ...
        <View style={styles.activityCard}>
          <Text style={styles.activityEmpty}>
            No recent activity yet.{'\n'}Connect to sync the latest data.
          </Text>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  activityEmpty: { color: '#475569', textAlign: 'center', lineHeight: 22, fontSize: 14 },
});

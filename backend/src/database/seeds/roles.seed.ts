...
export const seedRoles = async (dataSource: DataSource) => {
  ...
  const roles = [
    ...
    { name: 'Admin', description: 'General administration', isSystem: true, permissions: ['students:view_directory', 'hr:manage_staff', 'communication:view_notices', 'communication:manage_notices', 'communication:send_broadcast', 'communication:manage_templates', 'communication:view_logs', 'audit_reports:view', 'front_cms:manage', 'expenses:view', 'expenses:view_reports', 'expenses:manage_categories', 'expenses:manage_vendors', 'expenses:manage_records'] },
    { name: 'Accountant', description: 'Financial operations, expenses, fee collection, and reminders', isSystem: false, permissions: ['communication:view_notices', 'finance:collect_fees', 'finance:view_payments', 'finance:view_reports', 'finance:manage_fee_structure', 'finance:manage_reminders', 'hr:manage_payroll', 'expenses:view', 'expenses:view_reports', 'expenses:manage_categories', 'expenses:manage_vendors', 'expenses:manage_records'] },
    { name: 'Librarian', description: 'Manages school library, books, and circulation', isSystem: false, permissions: ['communication:view_notices', 'library:view_books', 'library:manage_books', 'library:issue_return', 'library:view_reports'] },

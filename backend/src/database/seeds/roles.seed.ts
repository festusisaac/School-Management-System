...
export const seedRoles = async (dataSource: DataSource) => {
  ...
  const roles = [
    ...
    { name: 'Admin', description: 'General administration', isSystem: true, permissions: ['students:view_directory', 'hr:manage_staff', 'communication:view_notices', 'communication:manage_notices', 'communication:send_broadcast', 'communication:manage_templates', 'communication:view_logs'] },

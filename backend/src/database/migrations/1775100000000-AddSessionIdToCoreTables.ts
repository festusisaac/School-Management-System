...
export class AddSessionIdToCoreTables1775100000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "student_attendance" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "homework" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "timetables" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "exams" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "exam_results" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "exam_groups" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "student_term_results" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "fee_assignments" ADD "sessionId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "staff_attendance" ADD "sessionId" uuid`);
        ...
        // 12. Backfill: Set all existing rows to the current active session

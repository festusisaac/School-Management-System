...
export class SystemSettingsService {
    ...
    async getPublicSettings() {
        ...
        return {
            ...
            interswitchMerchantCode: settings.interswitchMerchantCode,
            interswitchPayItemId: settings.interswitchPayItemId,
    ...
    async updateLogo(logoType: string, filePath: string): Promise<SystemSetting> {
        ...
        // Allowed logo types
        const allowedTypes = ['primaryLogo', 'favicon', 'printLogo', 'bursarSignature', 'principalSignature', 'ogImage'];

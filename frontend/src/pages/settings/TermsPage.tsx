...
const TermsPage = () => {
    ...
    const resetForm = () => {
        // Find default active session to simplify entry if needed, but here just leave empty or use active
    ...
    const columns: ColumnDef<AcademicTerm>[] = [
        ...
        },
        {
            ...
            header: 'Session',
            cell: ({ row }) => {
                const session = sessions.find(s => s.id === row.original.sessionId);
        ...
        <div className="p-6 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Manage the school's academic terms</p>
                </div>
                <button
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-3 p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg">
                        ...
                        <p className="text-sm font-medium">
                            Warning: This action will delete the term. Ensure no exams or records depend on it.
                        </p>
                    </div>

                ...
                <div className="flex items-center gap-3">
                    {row.original.studentPhoto ? (
                        ...
                        <div className={clsx(
                            ...
                            row.original.gender === 'Male' ? "bg-blue-500/10 text-blue-600 dark:text-blue-400" : "bg-pink-500/10 text-pink-600 dark:text-pink-400"
                        )}>
            ...
            cell: ({ row }) => (
                <span className={clsx(
                    ...
                    row.original.gender === 'Male'
                        ? "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-500/20 shadow-sm shadow-blue-500/5"
        ...
        { accessorKey: 'mobileNumber', header: 'Mobile' },
        {
            ...
            cell: ({ row }) => (
                <div className="flex items-center gap-2">
                    <Link to={`/students/profile/${row.original.id}`} className="p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" title="View">
                ...
                <div className="flex flex-wrap gap-4 w-full md:w-auto">
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            className="w-full md:w-40 px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                        >
                    ...
                    {students.map((student) => (
                        <div key={student.id} className="group bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800/50 p-6 shadow-sm hover:shadow-md transition-all relative">
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800/50 py-1 z-20 animate-in fade-in zoom-in-95 duration-200">
                                            <Link
                                                ...
                                                className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                            >
                                                <Eye className="w-4 h-4" />
                                                View Profile
                                            </Link>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1 group-hover:text-blue-600 transition-colors">{student.firstName} {student.lastName}</h3>
                                ...
                                <div className="w-full space-y-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    {student.mobileNumber && (
                                        <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                                            <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center shrink-0 text-blue-600">

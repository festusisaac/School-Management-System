  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        {/* Total Value */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-4 rounded-2xl shadow-xl shadow-primary-500/20 text-white flex items-center justify-between overflow-hidden relative">
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-900 dark:bg-gray-700 text-white rounded-xl text-sm font-bold hover:bg-black dark:hover:bg-gray-600 transition-all"
          >
            <Filter size={18} />
            Apply Filters
          </button>
                  ...
                  <td className="px-3 py-3 text-right border-b border-gray-50 dark:border-gray-800">
                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-1.5 hover:bg-primary-50  import React, { useState, useEffect, useCallback } from 'react';
import {
  Search,
  Filter,
  Download,
...
.Value -replace 'blue', 'primary'  rounded text-gray-400 hover:text-primary-600 transition-colors"
                        title="View Receipt"
                      >
                        <Eye size={14} />
                      </button>

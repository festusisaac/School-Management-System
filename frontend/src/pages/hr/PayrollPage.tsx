            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-white dark:bg-gray-800 border-2 border-primary-600 text-primary-600 dark:text-primary-400 hover:bg-primary-50  import React, { useState, useEffect } from 'react';
import {
    Users,
    Search,
    Filter,
...
.Value -replace 'blue', 'primary'  px-6 py-3 rounded-xl font-bold transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                    >
                        <Layers size={20} />
                        Bulk Generate
                    </button>
                                    ...
                                    <tr key={payroll.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    onClick={() => { setSelectedPayroll(payroll); setShowSlipModal(true); }}
                                                    className="p-2 text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-500 hover:bg-primary-50  import React, { useState, useEffect } from 'react';
import {
    Users,
    Search,
    Filter,
...
export default PayrollPage;
.Value -replace 'blue', 'primary'  rounded-lg transition-all"
                                                    title="View Payslip"
                                                >
                                                    <Eye size={18} />
                                                </button>

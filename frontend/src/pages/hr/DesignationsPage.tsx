                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <div className="flex justify-end gap-1">
                                                            <button
                                                                ...
                                                                className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-500 hover:bg-primary-50  import { useState, useEffect } from 'react';
import { Plus, Search, Edit2, Trash2, ShieldCheck, ChevronRight, Hash } from 'lucide-react';
import api from '../../services/api';
import { useToast } from '../../context/ToastContext';
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-5">
                            ...
                            <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-xl border border-gray-100 dark:border-gray-600">
                                <input
                                    type="checkbox"
                                    id="isDesigActive"
                                    className="w-5 h-5 text-primary-600 rounded-lg cursor-pointer accent-primary"
...
.Value -replace 'blue', 'primary'  rounded transition-colors"
                                                            >
                                                                <Edit2 size={16} />
                                                            </button>
                                                            <button

                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-primary-600 hover:bg-primary-50  import { useState, useEffect } from 'react';
import { Plus, Search, Edit2, Trash2, Building2, User } from 'lucide-react';
import api from '../../services/api';
import { useToast } from '../../context/ToastContext';
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        id="isActive"
                                        className="w-4 h-4 text-primary-600 rounded accent-primary"
...
.Value -replace 'blue', 'primary'  rounded-lg transition"
                                                >
                                                    <Edit2 size={18} />
                                                </button>
                                                <button
